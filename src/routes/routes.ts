...
const models: TsoaRoute.Models = {
    ...
    "IUserPayload": {
        ...
        "properties": {
            "nickName": {"dataType":"string","required":true},
            "playerNumber": {"dataType":"double","required":true},
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IScorePayload": {
        "dataType": "refObject",
        "properties": {
            "total_score": {"dataType":"double","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/auth',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"IAuthPayload"},
            };
        ...
        app.post('/users',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"array","array":{"dataType":"refObject","ref":"IUserPayload"}},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/users/scores/:id',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.getScores)),

            function UserController_getScores(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.getScores.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/scores',
            ...(fetchMiddlewares<RequestHandler>(ScoreController)),
            ...(fetchMiddlewares<RequestHandler>(ScoreController.prototype.getAlls)),

            function ScoreController_getAlls(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAlls.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/scores',
            ...(fetchMiddlewares<RequestHandler>(ScoreController)),
            ...(fetchMiddlewares<RequestHandler>(ScoreController.prototype.createUser)),

            function ScoreController_createUser(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"IScorePayload"},
            };
